...
const WorkoutEdit = (props) => {
    ...
    const workoutUpdate = (event, workout) => {
        ...
        console.log(editDef, editDesc, editRes);
        fetch(`http://localhost:4001/log/${props.workoutToUpdate.id}`, {
            method: 'PUT',
            ...
            <ModalBody>
                <Form onSubmit={workoutUpdate}>
                    ...
                    <FormGroup>
                        ...
                        <Input type="text" name="definition" value={editDef} onChange={(e) => setEditDef(e.target.value)}>
                            {/* <option></option>
